...
(function () {
  ...
  function launchMoneyRain() {
    ...
    const bills = Array.from({ length: 30 }, makeBill);
    ...
    function frame() {
      ...
      bills.forEach((b) => {
        ...
        ctx.rotate(b.angle);
        // Efecto de "aleteo": escalar en X con una onda sinusoidal
        const flap = Math.sin(Date.now() / 200 + b.x) * 0.15 + 0.85;
